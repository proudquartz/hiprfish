...
for k in range(0, image_registered.shape[2]):
    cells = skimage.measure.regionprops(image_seg, intensity_image = image_registered[:,:,k])
    avgint[:,k] = [x.mean_intensity for x in cells]

cell_info['max_intensity'] = np.max(avgint, axis = 1)

image_identification_filtered = image_identification.copy()
for i in range(cell_info.shape[0]):
    cell_label = cell_info.iloc[i,69]
    if cell_info.loc[i,'max_intensity'] < 0.1:
...
ax = plt.Axes(fig, [0, 0, 1, 1])
fig.add_axes(ax)
ax.imshow(image_identification_filtered[1500:1700, 700:900])
# scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', font_properties = {'size': 8}, height_fraction = 0.02)
# plt.gca().add_artist(scalebar)
plt.axis('off')
plt.savefig('{}_cell_1_neighborhood_filtered.pdf'.format(sample), dpi = 300)
plt.close()
...
ax = plt.Axes(fig, [0, 0, 1, 1])
fig.add_axes(ax)
ax.imshow(image_identification_filtered[900:1100, 800:1000])
# scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', font_properties = {'size': 8}, height_fraction = 0.02)
# plt.gca().add_artist(scalebar)
plt.axis('off')
plt.savefig('{}_cell_2_neighborhood_filtered.pdf'.format(sample), dpi = 300)
plt.close()
...
ax = plt.Axes(fig, [0, 0, 1, 1])
fig.add_axes(ax)
ax.imshow(image_identification_filtered[200:400, 500:700])
# scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', font_properties = {'size': 8}, height_fraction = 0.02)
# plt.gca().add_artist(scalebar)
plt.axis('off')
plt.savefig('{}_cell_3_neighborhood_filtered.pdf'.format(sample), dpi = 300)
plt.close()
...
ax = plt.Axes(fig, [0, 0, 1, 1])
fig.add_axes(ax)
ax.imshow(image_identification_filtered[1800:2000, 650:850])
# scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', font_properties = {'size': 8}, height_fraction = 0.02)
# plt.gca().add_artist(scalebar)
plt.axis('off')
plt.savefig('{}_prevotellamassila_neighborhood_filtered.pdf'.format(sample), dpi = 300)
plt.close()
...
# lautropia physical properties presentation
theme_color = 'white'
font_size = 12
fig = plt.figure()
color_list = ['yellowgreen', 'darkorange', 'dodgerblue']
fig.set_size_inches(cm_to_inches(11), cm_to_inches(11))
plt.plot(embedding_DSGN0549[:,0], embedding_DSGN0549[:,1], linestyle = 'None', marker = 'o', markersize = 1, alpha = 0.8, color = color_list[0], label = 'Probe set 1')
plt.plot(embedding_DSGN0560[:,0], embedding_DSGN0560[:,1], linestyle = 'None', marker = 'o', markersize = 1, alpha = 0.8, color = color_list[1], label = 'Probe set 2')
plt.plot(embedding_DSGN0561[:,0], embedding_DSGN0561[:,1], linestyle = 'None', marker = 'o', markersize = 1, alpha = 0.8, color = color_list[2], label = 'Probe set 3')
plt.xlabel('UMAP 1', fontsize = font_size, color = theme_color, labelpad = 0)
plt.ylabel('UMAP 2', fontsize = font_size, color = theme_color, labelpad = 0)
# plt.xticks([5,10,15,20])
# plt.yticks([5,10,15,20])
...
l = plt.legend(fontsize = font_size, loc = 9, frameon = False)
for p in l.legendHandles:
    p._legmarker.set_alpha(0)
...
plt.tick_params(labelsize = font_size, colors = theme_color, direction = 'in')
plt.subplots_adjust(left = 0.15, right = 0.98, bottom = 0.12, top = 0.98)
plt.savefig('{}_lautropia_physical_properties_umap_presentation.svg'.format(sample), dpi = 300, transparent = True)
plt.close()
...
sample = '/Users/hao/Documents/Research/Cornell/Projects/HIPRFISH/manuscript/nature_provisional_acceptance/figures_provisional_acceptance'
fig = plt.figure(frameon = False)
fig.set_size_inches(cm_to_inches(5.842),cm_to_inches(3))
ax = plt.Axes(fig, [0, 0, 1.7, 1])
fig.add_axes(ax)
ax.imshow(np.zeros((7800,3800)), cmap = 'RdBu', alpha = 0)
scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', location = 'upper right', font_properties = {'size': 6}, label = None, label_formatter = lambda x, y:'', fixed_value = 100, height_fraction = 0.04)
plt.gca().add_artist(scalebar)
plt.axis('off')
plt.subplots_adjust(left = 0, bottom = 0, right = 1, top = 1)
segfilename = sample + '/fov_size_7800_3800_5.842_scalebar.pdf'
fig.savefig(segfilename, dpi = 300, transparent = True)
plt.close()
...
fig.add_axes(ax)
ax.imshow(np.zeros((1000,1000)), cmap = 'RdBu', alpha = 0)
scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', location = 2, font_properties = {'size': 6})
plt.gca().add_artist(scalebar)
plt.axis('off')
plt.subplots_adjust(left = 0, bottom = 0, right = 1, top = 1)
segfilename = sample + '/fov_size_1000_3_scalebar.pdf'
fig.savefig(segfilename, dpi = 300, transparent = True)
plt.close()
...
plt.axis('off')
plt.subplots_adjust(left = 0, bottom = 0, right = 1, top = 1)
segfilename = sample + '/fov_size_2000_4.25_scalebar.pdf'
fig.savefig(segfilename, dpi = 300, transparent = True)
plt.close()
...
plt.axis('off')
plt.subplots_adjust(left = 0, bottom = 0, right = 1, top = 1)
segfilename = sample + '/fov_size_2000_3_scalebar.pdf'
fig.savefig(segfilename, dpi = 300, transparent = True)
plt.close()
...
fig.add_axes(ax)
ax.imshow(np.zeros((2000,2000)), cmap = 'RdBu', alpha = 0)
scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', location = 'upper left', label = None, label_formatter = lambda x, y:'', fixed_value = 25, height_fraction = 0.02)
plt.gca().add_artist(scalebar)
plt.axis('off')
plt.subplots_adjust(left = 0, bottom = 0, right = 1, top = 1)
segfilename = sample + '/fov_size_2000_6_scalebar.pdf'
...
fig.add_axes(ax)
ax.imshow(np.zeros((2000,2000)), cmap = 'RdBu', alpha = 0)
scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', location = 'upper right', label = None, label_formatter = lambda x, y:'', fixed_value = 25, height_fraction = 0.02)
plt.gca().add_artist(scalebar)
plt.axis('off')
plt.subplots_adjust(left = 0, bottom = 0, right = 1, top = 1)
segfilename = sample + '/fov_size_2000_5.75_scalebar.pdf'
fig.savefig(segfilename, dpi = 300, transparent = True)
plt.close()
...
sample = '/Users/hao/Documents/Research/Cornell/Projects/HIPRFISH/figures_dropbox'
fig = plt.figure(frameon = False)
fig.set_size_inches(cm_to_inches(2.75),cm_to_inches(2.75))
ax = plt.Axes(fig, [0, 0, 1, 1])
fig.add_axes(ax)
ax.imshow(np.zeros((200,200)), cmap = 'RdBu', alpha = 0)
scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', location = 'upper right', label = None, label_formatter = lambda x, y:'', fixed_value = 5, height_fraction = 0.04)
plt.gca().add_artist(scalebar)
plt.axis('off')
plt.subplots_adjust(left = 0, bottom = 0, right = 1, top = 1)
segfilename = sample + '/fov_size_200_2.75_scalebar.pdf'
fig.savefig(segfilename, dpi = 300, transparent = True)
plt.close()

sample = '/Users/hao/Documents/Research/Cornell/Projects/HIPRFISH/manuscript/nature_provisional_acceptance/figures_provisional_acceptance'
fig = plt.figure(frameon = False)
fig.set_size_inches(cm_to_inches(1.25),cm_to_inches(1.25))
ax = plt.Axes(fig, [0, 0, 1, 1])
fig.add_axes(ax)
ax.imshow(np.zeros((200,200)), cmap = 'RdBu', alpha = 0)
scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', location = 'upper right', label = None, label_formatter = lambda x, y:'', fixed_value = 5, height_fraction = 0.04)
...
plt.axis('off')
plt.subplots_adjust(left = 0, bottom = 0, right = 1, top = 1)
segfilename = sample + '/fov_size_200_1.25_scalebar.pdf'
fig.savefig(segfilename, dpi = 300, transparent = True)
plt.close()
...
fig.add_axes(ax)
ax.imshow(np.zeros((2000,2000)), cmap = 'RdBu', alpha = 0)
scalebar = ScaleBar(0.0675, 'um', frameon = False, color = 'white', location = 2, label = None, font_properties = {'size': 8})
plt.gca().add_artist(scalebar)
plt.axis('off')
plt.subplots_adjust(left = 0, bottom = 0, right = 1, top = 1)
segfilename = sample + '/fov_size_2000_4.25_scalebar.pdf'
